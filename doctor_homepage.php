...
<body>
    <div class="container">
        ...
        <div class="menu">
            ...
            <a href="#" onclick="showCategory('patients')"><i class="fas fa-users"></i> View Patients</a>
            <a href="#" onclick="showCategory('prescriptions')"><i class="fas fa-prescription"></i> Manage Prescriptions</a>
        ...
        <section id="profile" class="category-content">
            <h2>View Profile</h2>
            <p>Your doctor profile information will be displayed here.</p>
        </section>
    ...
    <p><a href="../Project_Folder/drugsTables.php">drugs stock</a></p>
     <p><a href="../Project_Folder/add_prescription.html">Give prescriptions</a></p>
